...
import { Bg, Wordmark, In, Kicker, Head, Body, Mono } from "../components/Chrome";
...
export const Hook: React.FC = () => (
  <AbsoluteFill><Bg><Wordmark />
    <In><Kicker>The problem</Kicker></In>
    <In delay={8}><Head>Your agent&apos;s bills<br />
      <span style={{ color: C.flow }}>outlive its budget.</span></Head></In>
    <In delay={22}><Body>
      A $12/month subscription funded with $500 dies in forty months, and so does whatever
      the agent was maintaining.
    </Body></In>
    <In delay={40}><div style={{ marginTop: 40, fontFamily: mono, fontSize: 30, color: C.fg }}>
...
export const Mechanism: React.FC = () => {
  ...
  return (
    <AbsoluteFill><Bg><Wordmark />
      <In><Kicker>What Weir does</Kicker></In>
      <In delay={6}><Head size={74}>Endow the bill,<br />not the agent.</Head></In>
      <In delay={20}><Body>
      ...
      <In delay={34}>
        <div style={{ marginTop: 52, fontFamily: mono, fontSize: 42, color: C.fg }}>
          accrued = P × (i₁ − i₀) / i₀
          <div style={{ height: 3, background: C.flow, marginTop: 14,
                        width: `${underline * 560}px`, borderRadius: 2 }} />
        </div>
      </In>
      <In delay={52}><div style={{ marginTop: 26, fontSize: 26, color: C.faint, maxWidth: 1060 }}>
...
/** 3 — the illustration carries this one. */
export const TheWeir: React.FC = () => (
  <AbsoluteFill><Bg><Wordmark />
    <In><Kicker>Principal held · overflow released</Kicker></In>
    <div style={{ marginTop: 30 }}>
      <WeirIllustration principal="250,000" spilling="0.896609" paid="0.01" />
    </div>
    <In delay={50}><div style={{ marginTop: 40, fontSize: 26, color: C.faint }}>
...
export const Proof: React.FC = () => (
  <AbsoluteFill><Bg><Wordmark />
    <In><Kicker>The proof, not the claim</Kicker></In>
    <div style={{ display: "flex", alignItems: "flex-end", gap: 60, marginTop: 44 }}>
      <In delay={10}><div>
        <div style={{ fontSize: 16, letterSpacing: 4, textTransform: "uppercase", color: C.faint }}>
          Principal committed</div>
        <Mono color={C.hold} size={72}>250000.00</Mono>
      </div></In>
      <In delay={22}><div style={{ fontSize: 60, color: C.faint, paddingBottom: 10 }}>≤</div></In>
      <In delay={30}><div>
        <div style={{ fontSize: 16, letterSpacing: 4, textTransform: "uppercase", color: C.faint }}>
          aTokens actually held</div>
        <Mono color={C.flow} size={72}>250000.89</Mono>
      </div></In>
    </div>
    <In delay={48}><Body>
      Committed is less than or equal to held, every block. If that ever inverted the
      guarantee would be a lie, so it is shown rather than asserted.
    </Body></In>
  </Bg></AbsoluteFill>
);

/** 5 — real footage of the live app, because the claim is about a real page. */
export const Permissionless: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps, durationInFrames } = useVideoConfig();
  const fade = spring({ frame, fps, from: 0, to: 1, config: { damping: 30 } });
  const out = interpolate(frame, [durationInFrames - 12, durationInFrames], [1, 0], {
    extrapolateLeft: "clamp", extrapolateRight: "clamp",
  });
  return (
    <AbsoluteFill style={{ background: C.ink }}>
      <AbsoluteFill style={{ opacity: fade * out }}>
        <OffthreadVideo src={staticFile("screen.mp4")} startFrom={30 * 58}
                        style={{ width: "100%", height: "100%", objectFit: "cover" }} muted />
      </AbsoluteFill>
      <AbsoluteFill style={{
        background: "linear-gradient(180deg, rgba(7,9,12,.92) 0%, rgba(7,9,12,.35) 42%, rgba(7,9,12,.95) 100%)",
      }} />
      <Bg><Wordmark />
        <In><Kicker>No keeper</Kicker></In>
        <In delay={8}><Head size={64}>Anyone can press it.<br />Nobody can redirect it.</Head></In>
        <In delay={26}><Body>
...
export const Stack: React.FC = () => {
  ...
  return (
    <AbsoluteFill><Bg><Wordmark />
      ...
      <In delay={54}><div style={{ marginTop: 38, fontFamily: mono, fontSize: 24, color: C.faint }}>
...
export const Close: React.FC = () => (
  <AbsoluteFill><Bg><Wordmark />
    <In><Head size={80}>An endowment your agent<br />
      <span style={{ color: C.flow }}>cannot outspend.</span></Head></In>
    <In delay={24}><Body>
      Because the cap is arithmetic, not a policy it could edit.
    </Body></In>
    <In delay={44}><div style={{ marginTop: 46, fontFamily: mono, fontSize: 24, color: C.faint }}>
